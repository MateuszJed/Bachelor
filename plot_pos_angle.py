...
# for n, file in enumerate(files):
#     t, x, y,anglex,angle = read_csv_data_to_list(file)
#     plot_graps(t, End_effector_X, 5,"Angle PID-controller in x-direction ", "Time[s]", "End effector [meter]", f"Trail: {n+1}")
# for n, file in enumerate(files):
#     t, x, y,anglex,angle = read_csv_data_to_list(file)
#     plot_graps(t, End_effector_Y, 6,"Angle PID-controller in y-direction ", "Time[s]", "End effector [meter]", f"Trail: {n+1}")
plt.show()