...
def inital_parameters_traj(start_pos,end_pos,start_vel,end_vel,start_time,end_time,flex_point):
    # Inital parameters:
    global q_0, q_1, v_0, v_1, t_0, t_1,t_f,t_a,t_d,h,T
    ...
    return T
    #return start_pos,end_pos,start_vel,end_vel,start_time,end_time,flex_point,rise_time,dec_time,total_time,length,

def asym_trajectory(t):#,q_0,q_1,v_0,v_1,h,T,t_0,t_1,t_f,t_a,t_d):
    if t<t_f:
        #calculate q_a:
